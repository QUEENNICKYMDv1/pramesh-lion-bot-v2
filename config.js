...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.ibb.co/fSZkGT2/istockphoto-1387900612-170667a.jpg'
module.exports = {
  botname: process.env.BOT_NAME || 'PAKAYA',
  ownername:process.env.OWNER_NAME || 'Kaveesha',
